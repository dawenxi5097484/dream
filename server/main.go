//Package main generated by 'freedom new-project dream'
package main

import (
	_ "dream/adapter/controller" //引入输入适配器 http路由
	_ "dream/adapter/repository" //引入输出适配器 repository资源库
	"dream/server/conf"
